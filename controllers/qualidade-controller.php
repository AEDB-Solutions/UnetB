<?php
	...
	if(!(is_bool($lat_q) === true || is_bool($long_q) === true)){
		$query = "INSERT INTO `networking_data` (`lat`, `long`, `download_speed`, `upload_speed`, `intensity`, `latency`, `packetloss`, `jitter`, `access_point`) VALUES ($lat_q, $long_q, $download_speed, $upload_speed, $intensity, $latency, $packetloss, $jitter_tt, '$access_point' );";
		$mySQL = new MySQL;
